...
export class TorrentSourceType1766865562826 implements MigrationInterface {
  name = 'TorrentSourceType1766865562826';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_users"("id", "username", "password_hash", "user_role", "torrent_resolutions", "torrent_languages", "torrent_seed", "token", "updated_at", "created_at", "torrent_video_qualities", "only_best_torrent") SELECT "id", "username", "password_hash", "user_role", "torrent_resolutions", "torrent_languages", "torrent_seed", "token", "updated_at", "created_at", "torrent_video_qualities", "only_best_torrent" FROM "users"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "users"("id", "username", "password_hash", "user_role", "torrent_resolutions", "torrent_languages", "torrent_seed", "token", "updated_at", "created_at", "torrent_video_qualities", "only_best_torrent") SELECT "id", "username", "password_hash", "user_role", "torrent_resolutions", "torrent_languages", "torrent_seed", "token", "updated_at", "created_at", "torrent_video_qualities", "only_best_torrent" FROM "temporary_users"`,
    );
